...
public class BinaryTree<E extends Comparable<E>> extends AbstractTree<E> {
	...
	protected Queue<TreeNode<E>> que=new LinkedList<TreeNode<E>>();
	protected TreeNode<E> cTree;

	protected List breadthFirstTraverHashSet = new ArrayList<>();
	...
	public void breadthFirstTraversal(TreeNode<E> root) {
		if (root == null)
			return;
		breadthFirstTraverHashSet.add(root.element);
		if (root.left != null)
			breadthFirstTraverHashSet.add(root.left.element);
		if (root.right != null)
			breadthFirstTraverHashSet.add(root.right.element);
